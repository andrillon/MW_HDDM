...
model_face_1 = hddm.HDDMStimCoding(mydata_face, stim_col= 'stim', depends_on={'v': 'stim'}, p_outlier=.05)
...
model_face_1_traces.to_csv(os.path.join(modelpath,'Faces/Model_1/model_face_1_traces_noZ.csv'))


#----------------------------------------#

# Faces - Model 2 (state)
model_face_2 = hddm.HDDMStimCoding(mydata_face, stim_col= 'stim', depends_on={'v': ['stim', 'State'], 't': 'State'}, p_outlier=.05)
model_face_2.find_starting_values()
model_face_2.sample(2000, burn=1000, dbname=os.path.join(modelpath,'Faces/Model_2/model_face_2_noZ.db'), db='pickle')
model_face_1.save(os.path.join(modelpath,'Faces/Model_2/model_face_2'))

# Extract stats
model_face_2_stats = model_face_2.gen_stats()
model_face_2_stats.to_csv(os.path.join(modelpath,'Faces/Model_2/model_face_2_stats_noZ.csv'))
...
model_face_2_traces.to_csv(os.path.join(modelpath,'Faces/Model_2/model_faces_2_traces_noZ.csv'))

#----------------------------------------#

# Digits - Model 1 (baseline)  
model_digit_1 = hddm.HDDMStimCoding(mydata_digit, stim_col= 'stim', depends_on={'v': 'stim'}, p_outlier=.05)
model_digit_1.find_starting_values()# Create model and start MCMC sampling
model_digit_1.sample(2000, burn=1000, dbname=os.path.join(modelpath,'Digits/Model_1/model_digit_1_traces_noZ.db'), db='pickle')
model_face_1.save(os.path.join(modelpath,'Digits/Model_1/model_digit_1'))

# Extract stats
model_digit_1_stats = model_digit_1.gen_stats()
model_digit_1_stats.to_csv(os.path.join(modelpath,'Digits/Model_1/model_digit_1_stats_noZ.csv'))
...
model_digit_1_traces.to_csv(os.path.join(modelpath,'Digits/Model_1/model_digit_1_traces_noZ.csv'))

#----------------------------------------#
# Digits - Model 2 (state) 
model_digit_2 = hddm.HDDMStimCoding(mydata_digit, include={'z'}, stim_col= 'stim', depends_on={'v': ['stim', 'State'], 't': 'State'}, p_outlier=.05)
model_digit_2.sample(2000, burn=1000, dbname=os.path.join(modelpath,'Digits/Model_2/model_digit_2_traces_noZ.db'), db='pickle')
model_digit_2.save(os.path.join(modelpath,'Digits/Model_2/model_digit_2'))

# Extract stats
model_digit_2_stats = model_digit_2.gen_stats()
model_digit_2_stats.to_csv(os.path.join(modelpath,'Digits/Model_2/model_digit_2_stats_noZ.csv'))
...
model_digit_2_traces.to_csv(os.path.join(modelpath,'Digits/Model_2/model_digit_2_traces_noZ.csv'))
...
sns.despine()
fig.savefig(os.path.join(modelpath, 'Digits/Model_2/Plots//NDT_noZ.jpeg'), dpi=600)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Digits/Model_2/Plots/Drift_go_noZ.jpeg'), dpi=600)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Digits/Model_2/Plots/Drift_nogo_noZ.jpeg'), dpi=600)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Faces/Model_2/Plots/NDT_noZ.jpeg'), dpi=600)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Faces/Model_2/Plots/Drift_go_noZ.jpeg'), dpi=600)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Faces/Model_2/Plots/Drift_nogo_noZ.jpeg'), dpi=600)
