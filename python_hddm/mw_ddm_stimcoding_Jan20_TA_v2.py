...
sns.despine()
fig.savefig(os.path.join(modelpath, 'Digits/Model_2/Plots//NDT.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Digits/Model_2/Plots/Threshold.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Digits/Model_2/Plots/StartingPoint.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Digits/Model_2/Plots/DriftBias.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Digits/Model_2/Plots/Drift_go.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Digits/Model_2/Plots/Drift_nogo.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Faces/Model_2/Plots//NDT.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Faces/Model_2/Plots/Threshold.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Faces/Model_2/Plots/StartingPoint.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Faces/Model_2/Plots/DriftBias.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Faces/Model_2/Plots/Drift_go.jpeg'), dpi=300)
...
axes.tick_params(axis='both',direction='out',length=6,width=2, labelsize='large')
sns.despine()
fig.savefig(os.path.join(modelpath, 'Faces/Model_2/Plots/Drift_nogo.jpeg'), dpi=300)
