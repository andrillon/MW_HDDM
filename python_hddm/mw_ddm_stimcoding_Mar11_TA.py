...
model_omni_3 = hddm.HDDMStimCoding(mydata, include={'z'}, stim_col= 'stim', split_param='z', depends_on={'v': ['stim', 'Task'], 'a': 'Task', 'z' : 'Task', 't': 'Task'}, p_outlier=.05)
...
model_omni_4 = hddm.HDDMStimCoding(mydata, include={'z'}, stim_col= 'stim', split_param='z', depends_on={'v': ['stim', 'State', 'Task'], 'a': ['State', 'Task'], 'z' : ['State', 'Task'], 't': ['State', 'Task']}, p_outlier=.05)
