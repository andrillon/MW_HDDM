...
if redo==1
    for n=1:length(files)
        ...
        for nPr=1:length(start_probe)
            ...
            find_waves=find((wvidx/500)>-20 & (wvidx/500)<0);
        ...
        save([root_path filesep 'behav' filesep 'HDDM_WIM' SubID '_localsleep_pup_perprobe_thrall_v5'],'hddm_subj')
    end
end
...
for n=1:length(files)
    ...
    if exist([root_path filesep 'behav' filesep 'HDDM_WIM' SubID '_localsleep_pup_perprobe_thrall_v5.mat'])==0
    ...
    nc=nc+1;
    allSubID{nc}=SubID;
    load([root_path filesep 'behav' filesep 'HDDM_WIM' SubID '_localsleep_pup_perprobe_thrall_v5'])
...
writetable(tbl_hddm,[root_path filesep 'hddm' filesep 'HDDM_WIM_localsleep_amp_pup_Dec21_perprobe_thrall_v5.txt']);
