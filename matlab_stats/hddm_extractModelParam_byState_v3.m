...
for nTask=1:2
    if nTask==1
        filename = '/Users/tand0009/WorkGit/projects/inprogress/MW_HDDM/Models/Digits/Model_2/model_digit_2_stats_noZ.csv';
    else
        filename = '/Users/tand0009/WorkGit/projects/inprogress/MW_HDDM/Models/Faces/Model_2/model_face_2_stats_noZ.csv';
    end
    delimiter = ',';
    startRow = 2;
...
%     mdl.D.z.M1= fitlme(tbl_z,sprintf('z~1+state+(1|subj)'));
    ...
    for ncond=1
        subplot(1, 3, 2+ncond); format_fig;
        for nstate=1:3
