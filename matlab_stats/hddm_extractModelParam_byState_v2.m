...
for nTask=1:2
    ...
    for ncond=1:2
        ...
        for nstate=1:3
            h = raincloud_plot(rcp_data{nstate,ncond}, 'band_width',0.25, 'box_on', 1, 'color', Colors(nstate,:), 'alpha', 0.5,...
...
%         tbl_t.state=reordercats(tbl_t.state,[2 1 3]);
    ...
    for ncond=2:3
        subplot(2, 2, 1+ncond); format_fig;
        for nstate=1:3
            h = raincloud_plot(rcp_data{nstate,ncond}, 'band_width',[], 'box_on', 1, 'color', Colors(nstate,:), 'alpha', 0.5,...
                'box_dodge', 1, 'box_dodge_amount', 0.4*(nstate-1)+0.1, 'dot_dodge_amount',  0.4*(nstate-1)+0.3,...
                'box_col_match', 1);
            set(h{2},'SizeData',144)
            for nstate2=nstate:3
    ...
    if nTask==1
        export_fig(['/Users/tand0009/Work/Documents/Articles/InPrep/wanderIM/figmaterial/Model_Digits_perState.fig'])
        export_fig(['/Users/tand0009/Work/Documents/Articles/InPrep/wanderIM/figmaterial/Model_Digits_perState.eps'],'-r 300')
    else
        export_fig(['/Users/tand0009/Work/Documents/Articles/InPrep/wanderIM/figmaterial/Model_Faces_perState.fig'])
        export_fig(['/Users/tand0009/Work/Documents/Articles/InPrep/wanderIM/figmaterial/Model_Faces_perState.eps'],'-r 300')
